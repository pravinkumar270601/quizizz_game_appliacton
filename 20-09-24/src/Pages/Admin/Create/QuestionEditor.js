...
const questionPoints = [
  { label: "1 points", value: "1points" },
  { label: "2 points", value: "2points" },
  { label: "3 points", value: "3points" },
  { label: "4 points", value: "4points" },
  { label: "5 points", value: "5points" },
  { label: "6 points", value: "6points" },
  { label: "7 points", value: "7points" },
  { label: "8 points", value: "8points" },
  { label: "9 points", value: "9points" },
  { label: "10 points", value: "10points" },
  { label: "11 points", value: "11points" },
  { label: "12 points", value: "12points" },
  { label: "13 points", value: "13points" },
  { label: "14 points", value: "14points" },
  { label: "15 points", value: "15points" },
  { label: "16 points", value: "16points" },
  { label: "17 points", value: "17points" },
  { label: "18 points", value: "18points" },
  { label: "19 points", value: "19points" },
  { label: "20 points", value: "20points" }
]

const questionSeconds = [
  { label: "5 Seconds", value: "5seconds" },
  { label: "10 Seconds", value: "10seconds" },
  { label: "20 Seconds", value: "20seconds" },
  { label: "30 Seconds", value: "30seconds" },
  { label: "45 Seconds", value: "45seconds" },
  { label: "1 minutes", value: "1minute" },
  { label: "1.5 minutes", value: "1.5minute" },
  { label: "2 minutes", value: "2minute" },
  { label: "3 minutes", value: "3minute" },
  { label: "5 minutes", value: "5minute" },
  { label: "10 Seconds", value: "10minute" },
  { label: "15 Seconds", value: "15minute" },
...
const handleNavigateClick = () => {
  navigate("/savequetion");  // Navigate to the QuestionEditor component
  setQuestionImage("")
};
