...
const CompletedPage = () => {
    ...
    console.log(GetAllPublishesWithStudent, " GetAllPublishesWithStudent");
    ...
    console.log(allPublishData.data, "allPublishData")


    useEffect(() => {

        console.log(GetAllPublishesWithStudent, "GetPublishByIdGetPublishById");


        if (GetAllPublishesWithStudent?.data) {
            const PublishheadContent = GetAllPublishesWithStudent?.data.map((data) => {
                ...
                return {
                    ...
                    score: data?.studentScores[0].score,
                    status: data?.studentScores[0].status,
                    student_id: data?.studentScores[0].status.student_id
    ...
    }, [GetAllPublishesWithStudent?.data])



    return (
        <Grid sx={{ padding: "20px" }}>
            {/* {if(allPublishData?.data){
