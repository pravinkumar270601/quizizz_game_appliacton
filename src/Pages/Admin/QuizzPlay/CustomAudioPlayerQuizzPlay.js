...
const CustomAudioPlayerQuizzPlay = ({ updateAudioURL }) => {
    ...
    return (
        ...
        >
            {/* <audio
                ...
                onEnded={handleEnded}
            /> */}
            <audio controls ref={audioRef} style={{ display: 'none',width:"100px",height:"100px" }}
                onEnded={handleEnded}>
                <source src={`${baseUrl}${updateAudioURL}`} type="audio/mp3" />
                <source src={`${baseUrl}${updateAudioURL}`} type="audio/x-m4a" />
                <source src={`${baseUrl}${updateAudioURL}`} type="audio/mpeg" />
                <source src={`${baseUrl}${updateAudioURL}`} type="audio/webm" />
...
export default CustomAudioPlayerQuizzPlay;
